...
COPY --from=wordlist1 /src/data/input/ /root/src/data/input/
COPY --from=wordlist2 /src/data/input/ /root/src/data/input/
COPY --from=corpus /src/data/input/ /root/src/data/input/
