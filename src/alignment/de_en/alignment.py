...
config = transformers.BertConfig.from_pretrained("/root/src/model/awesome_model_with_co/config.json")
model = transformers.BertModel.from_pretrained("/root/src/model/awesome_model_with_co/pytorch_model.bin", config=config)
tokenizer_config = transformers.BertConfig.from_pretrained("/root/src/model/awesome_model_with_co/tokenizer_config.json")
tokenizer = transformers.BertTokenizer.from_pretrained("/root/src/model/awesome_model_with_co/", config=tokenizer_config)
...
from de_morphological import de_morphological
...
def alignment(corpus_row, wordlist, test=False):
    ...
    alignmented = awesome_alignment(
        corpus_row[1], corpus_row[2], de_morphological, en_morphological
    )
    output_l = []
